...
int main(){
    ...
    cout<<" tamanio de la lista: " << miLista.tamano() << endl <<endl;
    ...
    cout << " tamanio de la lista: " << miListaDouble.tamano() <<endl <<endl;
    
    cout << miListaDouble.obtener(4) << endl <<endl;
    
    cout << miListaDouble.remover(2) << endl << endl;
    cout << " Mi lista es: " << miListaDouble.comoCadena() << endl <<endl;
